...
const Hero = () => {
    return (
        <section className="min-h-screen flex flex-col justify-center items-center text-center px-4 pt-20">
            ...
            >
                <span className="text-zinc-500 font-medium mb-4 block tracking-widest uppercase text-xs">Available for internships</span>
                ...
                <p className="text-xl md:text-2xl text-zinc-600 dark:text-zinc-400 max-w-2xl mb-10 leading-relaxed">
                    I build mobile and web applications with <span className="text-zinc-950 dark:text-white font-medium">Flutter</span> and modern technologies.
                </p>
